...
Button(root,text="New Operator",font='Arial 14 bold',fg='black',bg='Green2').grid(row=5,column=0,padx=100,pady=40)
Button(root,text="New Bus",font='Arial 14 bold',fg='black',bg='Orange').grid(row=5,column=1)
Button(root,text="New Route",font='Arial 14 bold',fg='black',bg='Lightblue').grid(row=5,column=2)
Button(root,text="New Run",font='Arial 14 bold',fg='black',bg='Pink').grid(row=5,column=3)
root.mainloop()
